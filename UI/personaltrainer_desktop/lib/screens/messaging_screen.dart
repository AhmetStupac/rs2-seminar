...
class _MessagingScreenState extends State<MessagingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final presenceProvider = Provider.of<SignalRProvider>(context, listen: false);
              ...
              children: [
                ...
                Expanded(
                  child: Consumer2<SignalRProvider, MessagesProvider>(
                    builder: (context, presenceProvider, messagesProvider, child) {
                      // Sync online users
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isSelected = messagesProvider.currentRecipientId == user.userId;
                          ...
                          return ListTile(
                            ...
                            onTap: () async {
                              await messagesProvider.connect(user.userId);
                            },
                          );
                        },
                      );
          ...
          Expanded(
            child: Column(
              children: [
                ...
                Consumer<MessagesProvider>(
                  builder: (context, provider, child) {
                    ...
                    final recipient = provider.onlineUsers
                        .where((u) => u.userId == provider.currentRecipientId)
                        .firstOrNull;
                ...
                Expanded(
                  child: Consumer<MessagesProvider>(
                    builder: (context, provider, child) {
                      if (provider.currentRecipientId == null) {
                        return const Center(
                          child: Text('Select a user from the list to start chatting'),
                        );
                      }
                ...
                Consumer<MessagesProvider>(
                  builder: (context, provider, child) {
                    final canSend = provider.isConnected && provider.currentRecipientId != null;
